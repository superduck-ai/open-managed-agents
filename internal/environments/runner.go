...
func (r *Runner) prepareManagedAgentLaunch(
	...
	if err != nil {
		return nil, fmt.Errorf("list managed agent Session events: %w", err)
	}
...
func (r *Runner) replaceRuntimeSkillArchives(
	...
	if err := r.db.ReplaceSessionSkillArchiveResources(ctx, session.WorkspaceID, session.ExternalID, archives); err != nil {
