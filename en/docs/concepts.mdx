...
- Git repository: repository and checkout information
- Memory store: durable memory shared across sessions
- URL: externally accessible material
...
<Card title="Create your first agent" icon="robot" href="/en/api/endpoints/create-agent">
