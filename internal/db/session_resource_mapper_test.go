	...
	tests := []struct {
	...
	}{
		{
			...
			contract: mapperBuilderContract{
				...
				bound: buildSessionResourceMapperList(
					yourbatis.DialectPostgres,
					"workspace-uuid",
					"session-external-id",
					MaxSessionOutputFileResources,
				),
				...
				wantSQLFragments: []string{
					...
					"file.uuid = resource.file_uuid",
					"file.workspace_uuid = resource.workspace_uuid",
					"file.external_id AS file_external_id",
					"resource.payload IS NOT NULL",
					"resource.resource_type = 'file'",
					"left(resource.path, char_length('/outputs/')) = '/outputs/'",
		...
		},
		{
			...
			contract: mapperBuilderContract{
				...
				bound: buildSessionResourceMapperFindByExternalID(
					yourbatis.DialectPostgres,
					"workspace-uuid",
					"session-external-id",
