...
func (f *fakeServiceDatabase) ListFilestoreSkillArchives(ctx context.Context, workspaceID, filesystemID int64) ([]db.FilestoreSkillArchive, error) {
	if f.listSkillArchivesFn == nil {
		panic("unexpected ListFilestoreSkillArchives call")
	}
	return f.listSkillArchivesFn(ctx, workspaceID, filesystemID)
}
