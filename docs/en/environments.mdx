...
sidebarTitle: "Cloud environment setup"
...
This page covers `type: cloud` environments. To run sandboxes on your own infrastructure, see [Self-hosted sandboxes](/docs/en/self-hosted-sandboxes).
...
Pass the environment ID as a string when [creating a session](/docs/en/sessions).
...
Cloud sandboxes include common runtimes out of the box. See [Cloud sandbox reference](/docs/en/cloud-sandboxes-reference) for the full list of pre-installed languages, databases, and utilities.

## Next steps

<CardGroup cols={2}>
  <Card title="Cloud sandbox reference" href="/docs/en/cloud-sandboxes-reference">
