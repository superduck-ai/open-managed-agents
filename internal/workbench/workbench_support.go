...
func RegisterOrgWorkbenchRoutes(r chi.Router, store OrganizationStore, secretService *secrets.Service, logger *slog.Logger) {
	newWorkbenchHandler(store, secretService, logger).registerRoutes(r)
}
