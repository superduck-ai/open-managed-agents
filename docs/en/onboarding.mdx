...
1. Copy the agent ID and [environment ID](/docs/en/environments) from Console.
2. Reference them in your code when [creating sessions](/docs/en/sessions):
