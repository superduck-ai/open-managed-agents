---
title: "Reference"
sidebarTitle: "Managed Agents reference"
description: "Event types, self-hosted worker CLI flags, supported MCP server types, and rate limits for Open Managed Agents."
---
