...
MCP tunnels and dreaming remain planned capabilities. The current release does not yet expose the complete Dreams API; see the implementation-status warning at the top of [Dreams](/docs/en/dreams).
