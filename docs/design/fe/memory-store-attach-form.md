...
- `web/src/features/managed-agents/api.ts`：Session 与 Deployment 创建、更新请求体

测试覆盖 501 拦截、500 原样提交、`read_only`、Session / Deployment 提交体、编辑不回写禁字段、无 store 回归。
