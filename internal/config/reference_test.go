...
func TestConfigExampleContainsOnlyCommonFields(t *testing.T) {
	...
	want := []string{
		...
		"web_search.timeout",
		"web_search.brave",
		"web_search.brave.country",
		"web_search.brave.search_language",
		"web_search.brave.ui_language",
		"web_search.brave.freshness",
		"web_search.brave.safe_search",
		"web_search.brave.spellcheck",
		"web_search.brave.result_filter",
		"web_search.brave.goggles",
		"web_search.brave.extra_snippets",
		"web_search.brave.units",
		"database",
		"database.url",
		"e2b",
		"e2b.api_key",
